        ...
        appBar: AppBar(
          ...
          actions: [
            FlutterFlowIconButton(
              borderColor: const Color(0x003939EF),
              borderRadius: 20.0,
              borderWidth: 1.0,
              buttonSize: 75.0,
          ...
          child: Stack(
            children: [
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: TextFormField(
                          ...
                          obscureText: false,
                          decoration: InputDecoration(
                            labelText: 'Search a meeting space..',
                              ...
                              Padding(
                                ...
                                child: Stack(
                                  children: [
                                    ...
                                    Align(
                                      alignment:
                                          const AlignmentDirectional(-0.89, 0.12),
                                      child: Text(
                                        'SAR125 /hour',
                                        style: FlutterFlowTheme.of(context)
                                            .bodyMedium
                                    ...
                                    Align(
                                      alignment:
                                          const AlignmentDirectional(-0.93, 0.43),
                                      child: Text(
                            ...
                            children: [
                              Stack(
                                children: [
                                  ...
                                  Align(
                                    alignment:
                                        const AlignmentDirectional(-0.88, -0.2),
                                    child: Padding(
                                      padding: const EdgeInsetsDirectional.fromSTEB(
                                          0.0, 10.0, 0.0, 0.0),
                                      child: Text(
                            ...
                            children: [
                              ...
                              Align(
                                ...
                                child: Padding(
                                  ...
                                  child: FFButtonWidget(
                                    onPressed: () async {
                                      context.pushNamed('LaysenValley');
                                    },
                                    text: 'View details',
                                    options: FFButtonOptions(
                                      height: 40.0,
                                      ...
                                      Expanded(
                                        child: Padding(
                                          ...
                                          child: TextFormField(
                                            ...
                                            obscureText: false,
                                            decoration: InputDecoration(
                                              labelText: 'Roshn Business Front',
                                              labelStyle:
                                                  FlutterFlowTheme.of(context)
                                                      .labelMedium
                                                      .override(
              ...
              Align(
                alignment: const AlignmentDirectional(0.0, 0.0),
                child: Padding(
                  padding: const EdgeInsetsDirectional.fromSTEB(0.0, 700.0, 0.0, 0.0),
                  child: Row(
                    mainAxisSize: MainAxisSize.max,
