...
import 'schema/meeting_space_record.dart';
...
export 'schema/meeting_space_record.dart';
...
/// Functions to query MeetingSpaceRecords (as a Stream and as a Future).
Future<int> queryMeetingSpaceRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      MeetingSpaceRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<MeetingSpaceRecord>> queryMeetingSpaceRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      MeetingSpaceRecord.collection,
      MeetingSpaceRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<MeetingSpaceRecord>> queryMeetingSpaceRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
